...
const Schedule = () => {
  const days = [
    ...
    },
    {
      ...
      date: 'Thursday',
      events: [
        { time: 'Async + 1 hrs live', title: ' Build + Technical Q&A Office Hours', icon: Code, description: '15:00- 16:00  CEST | LatAm Community Lead for SingularityNET and the ASI Alliance' },
      ],
    },
    {
      day: 'Oct 17',
